...
public class AudioManager : MonoBehaviour
{
    ...
    //[SerializeField] private GameObject adioUI;
   
    public enum Sfx { Jump, Shoot, BulletHit, PlayerDie, MonsterDie, Bat, Door, Button, NextScene }
    ...
    public void ButtonClick()
    {
        ...
        //Debug.Log("오디오창");
        VolumeUI volumeUI = GetComponentInChildren<VolumeUI>();
        volumeUI.UIshowup();
